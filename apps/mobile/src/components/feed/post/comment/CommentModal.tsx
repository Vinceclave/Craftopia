// apps/mobile/src/components/feed/post/comment/CommentModal.tsx 
import React, { useRef } from 'react';
import { 
  Modal, View, Text, ActivityIndicator, 
...
export const CommentModal: React.FC<CommentModalProps> = ({
  ...
  return (
    ...
    >
      <SafeAreaView edges={['left', 'right', 'bottom']} className="flex-1 bg-craftopia-surface">
        {/* Header */}
        ...
        {/* Comments List with Keyboard Aware Scroll */}
